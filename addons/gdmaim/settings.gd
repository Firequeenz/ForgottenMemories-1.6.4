...
func _init() -> void :
    ...
    add_entry("excluded_symbols", "excluded_symbols", "Excluded Symbols", "Enter a comma-separated list of symbols (class names, functions, etc.) to exclude from obfuscation.")
